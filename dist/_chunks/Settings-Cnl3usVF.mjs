...
import { P as PLUGIN_ID } from "./index-BLpoDBCS.mjs";
  ...
  return /* @__PURE__ */ jsx(Modal.Root, { open: isOpen, onOpenChange: (e) => handleOnOpenChange(e), children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, col: 1, children: [
      ...
      /* @__PURE__ */ jsx(Grid.Item, { children: /* @__PURE__ */ jsxs(Field.Root, { required: true, width: "100%", hint: "Select a language or leave empty for all languages", children: [
        ...
        /* @__PURE__ */ jsx(SingleSelect, { name: "langcode", onChange: handleSelectChange(setLangcode), ref: langcodeRef, value: langcode, placeholder: "Select Langcode", disabled: type === "", required: true, children: locales.map((locale) => /* @__PURE__ */ jsx(SingleSelectOption, { value: locale.code, children: locale.code }, locale.id)) }),
        /* @__PURE__ */ jsx(Field.Hint, {})
      ] }) }),
...
//# sourceMappingURL=Settings-Cnl3usVF.mjs.map
