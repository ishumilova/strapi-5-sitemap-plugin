...
import { Modal, Grid, Field, SingleSelect, SingleSelectOption, Button, Main, Box, Typography, LinkButton, Flex, Table, TFooter, Thead, Tr, Th, VisuallyHidden, Tbody, Td, IconButton } from "@strapi/design-system";
import { Plus, Pencil, Trash } from "@strapi/icons";
import { P as PLUGIN_ID } from "./index-CB0NgnHU.mjs";
...
function CollectionTypeModal({ isOpen, setModalOpen, setNewCollectionTypeAdded, typeToEdit = null, setTypeToEdit, editID = "", setEditID }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (typeToEdit && editID) {
        response = await fetch(`/${PLUGIN_ID}/admin`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    const getContentTypes = async () => {
      const response = await fetch(`/${PLUGIN_ID}/admin-get-content-types`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + getJwtToken()
    ...
    const getLocales = async () => {
      const response = await fetch(`/${PLUGIN_ID}/admin-get-locales`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + getJwtToken()
  ...
  useEffect(() => {
    if (type) {
      const getAllowedFields = async () => {
        const response = await fetch(`/${PLUGIN_ID}/admin-allowed-fields?type=${type}`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer " + getJwtToken()
  ...
  return /* @__PURE__ */ jsx(Modal.Root, { open: isOpen, onOpenChange: (e) => handleOnOpenChange(e), children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, col: 1, children: [
      ...
      /* @__PURE__ */ jsx(Grid.Item, { children: /* @__PURE__ */ jsxs(Field.Root, { required: true, width: "100%", hint: "Select a language or leave empty for all languages", children: [
  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsxs(Box, { paddingLeft: 10, paddingRight: 10, paddingBottom: 10, children: [
      ...
      /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
        ...
        /* @__PURE__ */ jsx(Button, { variant: "default", marginRight: 2, onClick: () => {
          saveBaseURL();
        }, children: "Save" })
      ] })
    ] }),
