...
import { P as PLUGIN_ID } from "./index-B1j-xgBm.mjs";
...
function CollectionTypeModal({
  ...
  const [collectionTypeFields, setCollectionTypeFields] = useState([]);
  ...
  return /* @__PURE__ */ jsx(Modal.Root, { open: isOpen, onOpenChange: (e) => handleOnOpenChange(e), children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, col: 1, children: [
      ...
      /* @__PURE__ */ jsx(Grid.Item, { children: /* @__PURE__ */ jsxs(Field.Root, { width: "100%", hint: "Optional thumbnail image", children: [
        ...
        /* @__PURE__ */ jsx(SingleSelect, { name: "thumbnail", onChange: handleSelectChange(setThumbnail), ref: thumbnailRef, value: thumbnail, placeholder: "Select Thumbnail", disabled: type === "", children: /* @__PURE__ */ jsx(SingleSelectOption, { value: "-", children: "None" }) }),
        /* @__PURE__ */ jsx(Field.Hint, {})
      ] }) })
    ] }) }),
...
//# sourceMappingURL=Settings-BAPIZ3XJ.mjs.map
