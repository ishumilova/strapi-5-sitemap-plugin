...
const index = require("./index-hgCMFvYS.js");
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open: isOpen, onOpenChange: (e) => handleOnOpenChange(e), children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 4, col: 1, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { required: true, width: "100%", hint: "Select a language or leave empty for all languages", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, { name: "langcode", onChange: handleSelectChange(setLangcode), ref: langcodeRef, value: langcode, placeholder: "Select Langcode", disabled: type === "", required: true, children: locales.map((locale) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: locale.code, children: locale.code }, locale.id)) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Hint, {})
      ] }) }),
...
//# sourceMappingURL=Settings-CADrsUJx.js.map
